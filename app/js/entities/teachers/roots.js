        ...
        AppManager.reqres.setHandler('teachers:homeRoot:entities', function(){
            if (Entities.homeRootListItems === undefined) {
                Entities.homeRootListItems = new Entities.RootsCollection([
                    { name: "home.panel.actions.offers", url: "offers", icon: "icon-newspaper", navigationTrigger: "teachers:offers:list", bg_class:"bg-success", msg: "<br />" },
                    ...
                    { name: "home.panel.actions.contacts", url: "users", icon: "icon-users", navigationTrigger: "teachers:users:root", bg_class:" bg-info", msg: "<br />" }
                ]);
            }
