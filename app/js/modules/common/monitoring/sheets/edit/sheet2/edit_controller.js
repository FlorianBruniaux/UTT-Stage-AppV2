                ...
                $.when(fetchingMonitoring).done(function(_monitoring){
                    ...
                    if (_monitoring !== undefined) {
                        ...
                        switch (_options.userCategory) {
                            case 'students':
                                path.push(
                                    ...
                                    { name: 'monitoring.sheet.edit.sheet2', url: 'monitoring/sheet2/edit', navigationTrigger: 'students:monitoring:edit:sheet', options: {sheet:'sheet2'} }
                                )
                                break;
                            ...
                            case 'teachers':
                                path.push(
                                    ...
                                    { name: 'monitoring.sheet.edit.sheet2', url: 'monitoring/'+_monitoring.get('_id')+'/edit/sheet2', navigationTrigger: 'teachers:monitoring:edit:sheet', options: {monitoringId: _monitoring.get('_id'), sheet:'sheet2'} }
                                )
                                break;
                            ...
                            case 'internship_managers':
                                path.push(
                                    ...
                                    { name: 'monitoring.sheet.edit.sheet2', url: 'monitoring/'+_monitoring.get('_id')+'/edit/sheet2', navigationTrigger: 'internship_managers:monitoring:edit:sheet', options: {monitoringId: _monitoring.get('_id'), sheet:'sheet2'} }
                                )
                                break;
                        }
                        ...
                        var view = new View.sheet2({
                            model: _monitoring,
                            title: polyglot.t('monitoring.edit')+' - '+ _monitoring.get('sheets').sheet2.name
                        });
