                ...
                $.when(fetchingMonitoring).done(function(_monitoring){
                    ...
                    if (_monitoring !== undefined) {
                        ...
                        switch (_options.userCategory) {
                            case 'students':
                                path.push(
                                    ...
                                    { name: 'monitoring.sheet.edit.sheet6', url: 'monitoring/sheet6/edit', navigationTrigger: 'students:monitoring:edit:sheet', options: {sheet:'sheet6'} }
                                )
                                break;
                            ...
                            case 'teachers':
                                path.push(
                                    ...
                                    { name: 'monitoring.sheet.edit.sheet6', url: 'monitoring/'+_monitoring.get('_id')+'/edit/sheet6', navigationTrigger: 'teachers:monitoring:edit:sheet', options: {monitoringId: _monitoring.get('_id'), sheet:'sheet6'} }
                                )
                                break;
                            ...
                            case 'internship_managers':
                                path.push(
                                    ...
                                    { name: 'monitoring.sheet.edit.sheet6', url: 'monitoring/'+_monitoring.get('_id')+'/edit/sheet6', navigationTrigger: 'internship_managers:monitoring:edit:sheet', options: {monitoringId: _monitoring.get('_id'), sheet:'sheet6'} }
                                )
                                break;
                        }
                        ...
                        var view = new View.sheet6({
                            model: _monitoring,
                            title: polyglot.t('monitoring.edit')+' - '+ _monitoring.get('sheets').sheet6.name
                        });
