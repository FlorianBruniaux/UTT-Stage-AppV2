        ...
        <form role="form" action="#" class="form-horizontal form-bordered">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-xs-3 col-sm-2 col-md-2 col-lg-1 control-label">Date :</label>
                        <div class="col-xs-6 col-sm-8 col-md-8 col-lg-10 datepicker" id="form-date" data-editors="date" >
                    ...
                    <div class="form-group">
                        <label class="col-xs-3 col-sm-2 col-md-2 col-lg-1 control-label">Time :</label>
                        <div class="col-xs-6 col-sm-8 col-md-8 col-lg-10" id="form-time" data-editors="time">
