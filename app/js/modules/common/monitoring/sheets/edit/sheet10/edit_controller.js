define([
    'app',
    'utt.stages',
    'modules/common/monitoring/sheets/edit/sheet10/edit_view'
    ...
    AppManager.module('MonitoringModule.Sheets.Edit', function(Edit, AppManager, Backbone, Marionette, $, _){
        ...
        Edit.Controller = {
            ...
            editSheet: function(_options){
                ...
                if(DEBUG) console.info('modules/common/monitoring/sheets/edit/sheet10/edit_controller.js -> editSheet()');
