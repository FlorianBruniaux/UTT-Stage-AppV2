                ...
                $.when(fetchingMonitoring).done(function(_monitoring){
                    ...
                    if (_monitoring !== undefined && _options.userCategory != 'students') {
                        ...
                        switch (_options.userCategory) {
                            case 'teachers':
                                path.push(
                                    ...
                                    { name: 'monitoring.sheet.edit.sheet9', url: 'monitoring/'+_monitoring.get('_id')+'/edit/sheet9', navigationTrigger: 'teachers:monitoring:edit:sheet', options: {monitoringId: _monitoring.get('_id'), sheet:'sheet9'} }
                                )
                                break;
                            ...
                            case 'internship_managers':
                                path.push(
                                    ...
                                    { name: 'monitoring.sheet.edit.sheet9', url: 'monitoring/'+_monitoring.get('_id')+'/edit/sheet9', navigationTrigger: 'internship_managers:monitoring:edit:sheet', options: {monitoringId: _monitoring.get('_id'), sheet:'sheet9'} }
                                )
                                break;
                        }
                        ...
                        var view = new View.sheet9({
                            model: _monitoring,
                            title: polyglot.t('monitoring.edit')+' - '+ _monitoring.get('sheets').sheet9.name
                        });
