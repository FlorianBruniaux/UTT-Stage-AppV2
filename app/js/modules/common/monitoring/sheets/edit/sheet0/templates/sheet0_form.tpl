            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6 col-sm-8 col-md-8 col-lg-10 datepicker" id="form-dates-from" data-editors="dates.from" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6 col-sm-8 col-md-8 col-lg-10 datepicker" id="form-dates-to" data-editors="dates.to" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6 col-sm-8 col-md-8 col-lg-10" id="form-uttResp" data-editors="uttResp" >
