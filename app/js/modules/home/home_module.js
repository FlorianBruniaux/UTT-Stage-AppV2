define([
    ...
    AppManager.module('HomeModule', function(HomeModule, AppManager, Backbone, Marionette, $, _){
        ...
        HomeModule.onStart = function(){
            if(DEBUG) console.info('Starting home_module');
        }
        
        HomeModule.onStop = function(){
            if(DEBUG) console.info('Stopping home_module');
        }
    ...
    AppManager.module('Routers.HomeModule', function(HomeModuleRouter, AppManager, Backbone, Marionette, $, _){
        ...
        var executeAction = function(action, arg){
            ...
            if(DEBUG) console.info("home.home_module.executeAction()");
        ...
        var API = {
            ...
            listRootOptions: function(){
                ...
                if(DEBUG) console.info("home.home_module.API.showRoot()");
                
                require([
                    'modules/home/root/root_controller'    
         ...
         *  Event = 'home:root'
         */
        AppManager.on('home:root', function(){
